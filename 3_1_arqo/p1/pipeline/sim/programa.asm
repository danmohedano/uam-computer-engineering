...
main:
  ...
  slti $s7, $t1, 2 # slt $r23, $r9, $r10  -> r23=1 si r9 < r10 else 0  = 1
  slti $t8, $s0, 2 # slt $r24, $r16, $r10 -> r24=1 si r16 < r10 else 0 = 0
...
salto:
  ...
  add $t4, $t4, $t4		# add $r12, $r12, $r12    -> r12 = 18 PERO por dependecia vale 16
  j testj				# -> salta al final del programa
  nop
  nop
  nop
  add $t4, $t4, $t4 	# -> no se ejecuta
testj:
  lw $t4, 0($zero)  	# -> r12 = 1
final:
