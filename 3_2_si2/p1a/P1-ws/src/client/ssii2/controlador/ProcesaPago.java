...
private void printAddresses(HttpServletRequest request, HttpServletResponse response) throws SocketException {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        bp.getRequestContext().put(BindingProvider.ENDPOINT_ADDRESS_PROPERTY, getServletContext().getInitParameter("rutaservicio"));
        ...
        try{
            ...
            // Si es una excepcion esperada, simplemente se vuelve a throwear
            throw ex;
        } catch (Exception ee){
            // Si es otra excepcion que no se esperaba, error
