...
typedef struct _DATA{
    char* id;           /* lexema*/
    int category;       /* variable, parameter or function */
    int type;           /* boolean or int */
    int clase;          /* scalar o vector */
    int size;           /* size of the vector */
    int n_param;        /* number of parameters of function */
    int pos_param;      /* position of the function parameter */
    int n_local_var;    /* number of local variables in function */
    int pos_local_var;  /* position of the local variable inside the declaration section of the function */
} DATA;
