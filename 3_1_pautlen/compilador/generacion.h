...
/* Hace lo mismo que 'asignarDestinoEnPila' pero leyendo las dos posiciones de la
cima de la pila en orden inverso.
*/
...
no (es_variable) se deja en la pila el valor correspondiente*/
